...
console.log('Cloud search checks passed: Misc. pill, N=184, integrated search result, animation, filter reset, single-entity state, and clearing search on a different cloud selection.');
